...
public:
	...
	decltype(auto) iterator_find(value val)
	{
		auto b = begin();
		auto e = end();
		while (b != e)
	...
	decltype(auto) iterator_reverse_sequence_find(size_t len, pointer val, eSequence e)
	{
	...
	decltype(auto) reverse_sequence_find(size_t len, pointer val, eSequence e)
	{
		switch (e)
		{
			default:
